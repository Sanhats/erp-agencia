...
/** Token para que Puppeteer (API de PDF) pueda acceder sin sesión. Usar PDF_SECRET o CRON_SECRET en .env */
function isValidPdfToken(token: string | undefined): boolean {
  const secret = process.env.PDF_SECRET || process.env.CRON_SECRET;
  return !!secret && typeof token === 'string' && token === secret;
}
